...
export default function Slider<T>({
  ...
  useEffect(() => {
    ...
    if (windowWidth < 500) {
      ...
      return setNumberOfItems(itemPerRow - 3 || 1)
    }
    if (windowWidth < 1024) {
      if (itemPerRow < 3) {
        return setNumberOfItems(1.5)
      }
      return setNumberOfItems(itemPerRow - 2 || 1)
    }
    if (windowWidth < 1280) {
