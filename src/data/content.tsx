...
export const promotionTag = {
	heading: "GIẢM GIÁ LÊN ĐẾN 50% 2023",
	description:
		"Chúng tôi còn có nhiều hoạt động thú vị khác và được hỗ trợ Tại cửa hàng!",
};
export const shoes = [
	{
		slug: "airForce1",
...
export const footerData = {
	description:
		"Trang web chuyên cung cấp các phụ kiện phong thuỷ và trang sức cổ điển, mang lại sự may mắn, bình an và thịnh vượng cho người sử dụng.",
	footerLinks: [
		{
			title: "Trang chính",
			links: [
				{ href: "/home", name: "Trang chủ" },
				{ href: "/products", name: "Bộ sưu tập" },
				{ href: "/cart", name: "Giỏ hàng" },
				{ href: "/checkout", name: "Thanh toán" },
				{ href: "/blog", name: "Bài viết" },
			],
		},
		{
			title: "Trang đơn",
			links: [
				{ href: "/product/yellowLow", name: "Chi tiết sản phẩm" },
				{
		...
		{
			title: "Trang khác",
			links: [{ href: "/rt", name: "Không tìm thấy" }],
		},
		{
			title: "Trang tiện ích",
			links: [
				{ href: "/faq", name: "Câu hỏi thường gặp" },
				{ href: "/contact", name: "Liên hệ" },
				{ href: "/forgot-pass", name: "Quên mật khẩu" },
				{ href: "/login", name: "Đăng nhập" },
				{ href: "/signup", name: "Đăng ký" },
			],
		},
	],
};
